...
const leverageCal = async (symbol, priceCal, stopPriceCal, side) => {
  ...
  const getNotionalLv = await apiBinance.getNotionalLv(symbol)
  const gbrackets = getNotionalLv[0].brackets
      ...
      if (openLongShort.openLongShort < budget) {
        ...
        if (side === 'BUY') {
          if (cal > stopPriceCal) {
            ...
            // console.log('stopprice', stopPriceCal)
            console.log('StartMargin', openLongShort.openLongShort)
            console.log('StartLP', cal)
            console.log('stopPriceCal', stopPriceCal)
            console.log('StartMaxiumQty', maximumQty)
          ...
          if (cal < stopPriceCal) {
            ...
            while (cal > stopPriceCal) {
              ...
              console.log('maximumQty', maximumQty)
