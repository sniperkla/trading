export const translations = {
  en: {
    ...
    contact: 'Contact',
    contactDesc: 'Connect with us on your favorite platform!',
    line: 'LINE',
    facebook: 'Facebook',
    telegram: 'Telegram',
    prev: 'Previous',
    next: 'Next',
    // Video slider translations
    englishDemo: 'English Demo',
    thaiDemo: 'Thai Demo',
    demo: 'Demo',
    previousVideo: 'Previous video',
    nextVideo: 'Next video',
    // Image slider translations
    ...
    useSimpleViewer: 'Use Simple Viewer',
  ...
  th: {
    ...
    next: 'ถัดไป',
    // Video slider translations
    englishDemo: 'ตัวอย่างภาษาอังกฤษ',
    thaiDemo: 'ตัวอย่างภาษาไทย',
    demo: 'ตัวอย่าง',
    previousVideo: 'วิดีโอก่อนหน้า',
    nextVideo: 'วิดีโอถัดไป',
    // Image slider translations
    viewFullSize: 'ดูภาพเต็มขนาด',
    ...
    tapToFullscreen: 'แตะปุ่มเต็มหน้าจอเพื่อดูได้ดีขึ้น',
    pdfLoading: 'กำลังโหลด PDF...',
    errorLoadingPDF: 'เกิดข้อผิดพลาดในการโหลด PDF',
    pdfVersionError: 'อาจเกิดจากเวอร์ชั่น PDF.js ไม่ตรงกัน ลองตัวเลือกด้านล่าง',
    openPDFDirectly: 'เปิด PDF โดยตรง',
    useSimpleViewer: 'ใช้ตัวดูแบบง่าย',
    firstPage: 'หน้าแรก',
  ...
  hi: {
    ...
    contact: 'संपर्क करें',
    contactDesc: 'अपने पसंदीदा प्लेटफ़ॉर्म पर हमसे जुड़ें!',
    line: 'लाइन',
    facebook: 'फेसबुक',
    telegram: 'टेलीग्राम',
    prev: 'पिछला',
    ...
    tapToFullscreen: 'बेहतर दृश्य के लिए फुलस्क्रीन बटन पर टैप करें',
    pdfLoading: 'PDF लोड हो रहा है...',
    errorLoadingPDF: 'PDF लोड करने में त्रुटि',
    pdfVersionError:
      'यह PDF.js संस्करण मिसमैच के कारण हो सकता है। नीचे दिए गए विकल्पों में से एक प्रयास करें।',
    openPDFDirectly: 'PDF सीधे खोलें',
    useSimpleViewer: 'सरल व्यूअर का उपयोग करें',
    firstPage: 'पहला पेज',
  ...
  ru: {
    ...
    contact: 'Контакт',
    contactDesc: 'Свяжитесь с нами на вашей любимой платформе!',
    line: 'Лайн',
    facebook: 'Фейсбук',
    telegram: 'Телеграм',
    prev: 'Предыдущий',
    next: 'Следующий',
    // Video slider translations
    englishDemo: 'Английская демонстрация',
    thaiDemo: 'Тайская демонстрация',
    demo: 'Демонстрация',
