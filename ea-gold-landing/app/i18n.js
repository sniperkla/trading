export const translations = {
  ...
  pdfVersionError: 'This may be due to a PDF.js version mismatch. Try one of the alternatives below.',
  ...
  pdfVersionError: 'यह PDF.js संस्करण मिसमैच के कारण हो सकता है। नीचे दिए गए विकल्पों में से एक प्रयास करें।',
  ...
  useZoomControls: 'PDF आकार समायोजित करने के लिए ज़ूम नियंत्रण का उपयोग करें',
  ...
  getSupportDesc: 'После прохождения KYC отправьте номер счета через каналы ниже для активации бота.',
    ...
    tapToFullscreen: 'Нажмите на кнопку полноэкранного режима для лучшего просмотра',
    pdfLoading: 'Загрузка PDF...',
    errorLoadingPDF: 'Ошибка загрузки PDF',
    pdfVersionError: 'Это может быть связано с несовместимостью версий PDF.js. Попробуйте один из вариантов ниже.',
