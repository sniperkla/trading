      ...
      return function PDFDisplay({
          ...
          const checkSize = () => {
            ...
            if (viewerContainerRef.current) {
              ...
              const availableWidth =
                viewerContainerRef.current.clientWidth - (mobile ? 24 : 32)
        ...
        function onDocumentLoadError(err) {
          ...
          if (isVersionError) {
            ...
            setError(
              `PDF.js version mismatch: API ${apiVersion} ≠ Worker ${workerVersion}. Try Simple Viewer instead.`
            )
        ...
        return (
          <div
            ...
            className="w-full overflow-y-auto flex flex-col items-center justify-center"
            style={{
          ...
          >
            {loading && (
              <div className="flex flex-col items-center justify-center py-16">
                ...
                <p className="mt-4 text-white/80">
                  {translations?.[lang || 'en']?.pdfLoading || 'Loading PDF...'}
                </p>
              </div>
            )}
            ...
            {error && (
              <div className="flex flex-col items-center justify-center py-16 text-center">
                ...
                <h3 className="text-red-400 text-lg font-medium mb-2">
                  {translations?.[lang || 'en']?.errorLoadingPDF ||
                    'Error Loading PDF'}
                </h3>
                <p className="text-white/70 max-w-md mb-4">{error}</p>
                <p className="text-white/60 max-w-md mb-6 text-sm">
                  {translations?.[lang || 'en']?.pdfVersionError ||
                    'This may be due to a PDF.js version mismatch. Try one of the alternatives below.'}
                </p>
            ...
            {!loading && !error && (
              <div className="flex flex-col items-center justify-center w-full relative">
                {/* Fullscreen button overlay on PDF */}
                <div className="absolute top-2 right-2 z-10">
                  <button
                    onClick={() => toggleFullscreen && toggleFullscreen()}
                    className="p-2 bg-black/60 hover:bg-black/80 rounded-lg transition-colors shadow-lg"
                    title={
                      translations?.[lang || 'en']?.fullscreen || 'Fullscreen'
                    }
                  >
                ...
                >
                  <Page
                    ...
                    style={{
                      // Better mobile rendering and centering
                      height: 'auto',
                      margin: '0 auto',
                      display: 'block'
                    }}
                  ...
                  <div className="flex justify-center mt-2">
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="text-xs px-3 py-1 bg-gray-700/40 hover:bg-gray-700/60 text-gray-300 rounded-lg"
                    >
                      {translations?.[lang || 'en']?.openPDFTab ||
                        'Open PDF in new tab'}
                    </a>
                  </div>
                  {/* PDF Controls */}
                  <div className="flex flex-col gap-4 mt-4">
                    ...
                    {numPages > 1 && (
                      <div className="flex justify-center items-center gap-2 text-white">
                        <button
                          ...
                          title={
                            translations?.[lang || 'en']?.firstPage ||
                            'First Page'
                          }
                        >
                        ...
                        <button
                          ...
                          className="p-2 bg-yellow-500/20 hover:bg-yellow-500/40 rounded-lg disabled:opacity-50 transition-all"
                          title={
                            translations?.[lang || 'en']?.previousPage ||
                            'Previous Page'
                          }
                        >
                    ...
                    <div className="flex justify-center items-center gap-2 text-white">
                      <button
                        ...
                        title={
                          translations?.[lang || 'en']?.zoomOut || 'Zoom Out'
                        }
                      >
                      ...
                      <button
                        ...
                        title={
                          translations?.[lang || 'en']?.resetZoom ||
                          'Reset Zoom'
                        }
                      >
                      ...
                      <button
                        ...
                        className="p-2 bg-gray-700/40 hover:bg-gray-700/60 rounded-lg disabled:opacity-50 transition-all"
                        title={
                          props.translations?.[props.lang || 'en']?.zoomIn ||
                          'Zoom In'
                        }
                      >
        ...
        <div className="h-full flex flex-col">
          ...
          <div className="flex justify-between items-center p-3 bg-black/90 border-b border-white/10 shrink-0">
            <h3 className="text-lg font-bold text-yellow-400">
              {translations?.[lang || 'en']?.pdfGuide || 'PDF Guide'}{' '}
            ...
            <div className="flex items-center gap-2">
              <a
                ...
                title={
                  translations?.[lang || 'en']?.downloadPDF || 'Download PDF'
                }
              >
              ...
              <a
                ...
                className="p-2 hover:bg-white/10 rounded-lg transition-colors"
                title={
                  translations?.[lang || 'en']?.openInNewTab ||
                  'Open in New Tab'
                }
              >
              ...
              <button
                ...
                className="p-2 hover:bg-white/10 rounded-lg transition-colors"
                title={
                  translations?.[lang || 'en']?.exitFullscreen ||
                  'Exit Fullscreen'
                }
              >
          ...
          {/* PDF Content */}
          <div
            className="flex-1 overflow-y-auto p-4 flex justify-center items-center"
  ...
  return (
    <div className="relative w-full h-full flex flex-col items-center justify-center overflow-hidden">
      ...
      >
        {/* Main Content */}
        <div
          className="relative bg-black/40 backdrop-blur-md rounded-2xl p-6 shadow-2xl overflow-hidden"
          style={{
            maxHeight: isMobile ? 'calc(70vh - 60px)' : 'auto'
          }}
        >
          <div
            className="overflow-y-auto flex justify-center items-center"
            style={{
              WebkitOverflowScrolling: 'touch',
